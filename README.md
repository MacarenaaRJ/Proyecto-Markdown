...
1. Descargue e instale Go desde [aquí](https://golang.org/dl/).
2. Verifique la instalación con `go version` en la terminal.

### React

1. Asegúrese de tener Node.js y npm instalados. Puede descargarlos desde [aquí](https://nodejs.org/en/download/).
2. Instale Create React App globalmente con `npm install -g create-react-app`.
3. Verifique la instalación con `create-react-app --version`.
